...
namespace Pinnacle
{
    ...
    public class VisualStudioTabControl : TabControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (var i = 0; i <= TabCount - 1; i++)
            {
                ...
                if (i == SelectedIndex)
                {
                    ...
                    Drawer.FillRectangle(
                        new SolidBrush(Class.Users.BackColors),//this.ActiveColor
                    ...
                    if (this.ShowClosingButton)
                    {
                        e.Graphics.DrawString(" x ", Font, ClosingColorBrush, HeaderSize.Right - 18, 0);
                    }
                }
                else
                {
            ...
            Drawer.DrawLine(new Pen(this.horizLineColor, 5), new Point(0, 22), new Point(Width, 22));
