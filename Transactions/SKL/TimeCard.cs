...
{
    public partial class TimeCard : Form,ToolStripAccess
    {
        private static TimeCard _instance;
        public static TimeCard Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new TimeCard();
                return _instance;
            }
        }
        public TimeCard()
        ...
        public void companyload()
        {
            try
            {
                ...
                string sel1 = "select distinct a.gtcompmastid,a.compcode from  gtcompmast a join hrnhmast b on a.gtcompmastid=b.compcode  where a.ptransaction ='COMPANY'  order by 2;";
        ...
        public void GridLoad()
        {
            try
            {
                ...
                string sel1 = "select a.hrnhmastid,a.finyear,a.docid,c.compcode,date_format(a.date,'%d-%m-%Y') as date,a.active from hrnhmast a join gtcompmast c on a.compcode=c.gtcompmastid  order by 1;";
        ...
        private void dataGridView1_CellLeave(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //    {
            //        if (Convert.ToString(row.Cells["holidaycategory"].Value) == "")
            //        {
        ...
        public void News()
        {
            ...
            tabControl1.SelectTab(tabPage1); autonumberload(); combocompcode.Select();
