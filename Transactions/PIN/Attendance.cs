...
namespace Pinnacle.Transactions.PIN
{
    ...
    public partial class Attendance : Form, ToolStripAccess
    {
        ...
        private void DeviceCommunication_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                progressBar1.Value = 0; lblattcount.Text = ""; lblprogress1.Text = ""; listviewchecklistip.Items.Clear(); listviewchecklistip1.Items.Clear(); listviewchecklistip2.Items.Clear();
        ...
        public void News()
        {
            ...
            splitContainer1.BackColor = Class.Users.BackColors;
            ...
            lblcardreadercount.BackColor = Class.Users.BackColors;
            ...
            checkcard1.BackColor = Class.Users.BackColors;
            ...
            tabPage1.BackColor = Class.Users.Color1;
            list2contextmenu.Font=Class.Users.FontName;
            listremovechecklistip.Font = Class.Users.FontName;
            listviewchecklistip.Font = Class.Users.FontName;
            //lvLogs.Font = Class.Users.FontName;
            //listviewattdown.Font = Class.Users.FontName;
            //Lvdownall.Font = Class.Users.FontName;
            //Lvdownremove.Font = Class.Users.FontName;
        ...
        private void BtnConnect_Click(object sender, EventArgs e)
        {
            ...
            lblprogress1.Text = ""; listViewupload.Items.Clear();
                        ...
                        if (listviewattdown.CheckedItems.Count > 0)
                        {
                            ...
                            for (int j = 0; j < allip1.Items.Count; j++)
                            {
                                if (allip1.Items[j].SubItems[3].Text == "True")
                                {
                                    ...
                                    Cursor = Cursors.WaitCursor;
                                    DataTable dt = dev.AllIp(Class.Users.HCompcode, allip1.Items[j].SubItems[1].Text);
                                    ...
                                    for (i = 0; i < maxip; i++)
                                    {
                                        ...
                                        if (bIsConnected == true)
                                        {
                                            ...
                                            if (axCZKEM1.ReadGeneralLogData(iMachineNumber))//read all the attendance records to the memory
                                            {
                                                ...
                                                {
                                                    DateTime outtime; DateTime timediffer;
                                                    ...
                                                    if (Convert.ToDateTime(inputDate) >= frmdate.Value.Date && Convert.ToDateTime(inputDate) <= todate.Value.Date.AddDays(1).AddTicks(-1))
                                                    {
                                                        ...
                                                        iGLCount++;
                                                        string outtime1 = "";
                                                        var ot = ""; var tdiffer = ""; DataTable dt0 = new DataTable();


                                                        string sel = "SELECT max(a.attlogid)as attlogid FROM " + Class.Users.HCompcode + "TRS_TEMPATTLOG a join asptblemp b on a.ENROLLNO=b.idcardno and b.active='T' where a.ENROLLNO='" + idcard + "'";
                                                        DataSet ds = Utility.ExecuteSelectQuery(sel, "" + Class.Users.HCompcode + "TRS_TEMPATTLOG");
                                                        DataTable dtt = ds.Tables["" + Class.Users.HCompcode + "TRS_TEMPATTLOG"];
                                                        if (dtt.Rows[0]["attlogid"].ToString() != "")
                                                        {
                                                            string sel0 = "select DISTINCT A.indate,max(a.intime) as statetime FROM " + Class.Users.HCompcode + "TRS_TEMPATTLOG A where A.attlogid='" + dtt.Rows[0]["attlogid"].ToString() + "' group by A.indate ";
                                                            DataSet ds0 = Utility.ExecuteSelectQuery(sel0, "" + Class.Users.HCompcode + "TRS_TEMPATTLOG");
                                                            dt0 = ds0.Tables["" + Class.Users.HCompcode + "TRS_TEMPATTLOG"];

                                                            if (Convert.ToString(dt0.Rows[0]["indate"].ToString()) != "")
                                                            {
                                                                outtime1 = "";

                                                                DateTime statetime = DateTime.Parse(dt0.Rows[0]["statetime"].ToString());
                                                                DateTime endtime = DateTime.Parse(time);
                                                                TimeSpan differ = endtime.Subtract(statetime);
                                                                TimeSpan differ1 = endtime - statetime;
                                                                DateTime outtime2 = endtime + differ;
                                                                outtime1 = endtime.ToLongTimeString();
                                                                if (differ1.Ticks < 0)
                                                                {
                                                                    tdiffer = "F-Puch";
                                                                    ot = "0";
                                                                ...
                                                                {
                                                                    tdiffer = differ1.ToString();
                                                                    ot = dt0.Rows[0]["statetime"].ToString();
                                                                }
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            string ins = "INSERT INTO " + Class.Users.HCompcode + "TRS_TEMPATTLOG(MACHINENUMBER, IPADDRESS, ENROLLNO,  DATETIMERECORD,indate,intime,outtime)VALUES(" + macno + ",'" + ip + "'," + idcard + ",'" + dat + " " + time + "','" + Convert.ToDateTime(dat).ToString("yyyy-MM-dd") + "','" + time + "','" + outtime1 + "')";
                                                            Utility.ExecuteNonQuery(ins);
                                                        }
                                                        else
                                                        {
                                                            string ins = "INSERT INTO " + Class.Users.HCompcode + "TRS_TEMPATTLOG(MACHINENUMBER, IPADDRESS, ENROLLNO,  DATETIMERECORD,indate,intime,outtime)VALUES(" + macno + ",'" + ip + "'," + idcard + ",'" + dat + " " + time + "','" + Convert.ToDateTime(dat).ToString("yyyy-MM-dd") + "','" + time + "','" + time + "')";
                                                            Utility.ExecuteNonQuery(ins);
                                                        }
                                                        ListViewItem list = new ListViewItem();
                                                        ...
                                                        list.SubItems.Add(ot);
                                                        list.SubItems.Add(tdiffer);
                                                        list.SubItems.Add(outtime1);
                                                        this.listfilter.Items.Add((ListViewItem)list.Clone());
                                        ...
                                        if (lvLogs.Items.Count > 0)
                                        {
                                            ...
                                            foreach (ListViewItem item in lvLogs.Items)
                                            {
                                                ...
                                                lblprogress1.Refresh();
                                                string del = "DELETE FROM " + Class.Users.HCompcode + "TRS_ATTLOG   WHERE ENROLLNO='" + Convert.ToString(item.SubItems[2].Text) + "' AND DATETIMERECORD='" + item.SubItems[5].Text + "' AND IPAddress ='" + Convert.ToString(item.SubItems[3].Text) + "'";
                                                Utility.ExecuteNonQuery(del);
                                                string ins = "INSERT INTO " + Class.Users.HCompcode + "TRS_TEMPATTLOG(MACHINENUMBER, IPADDRESS, ENROLLNO, VERIFYMODE, INOUTMODE, WORKCODE, DATETIMERECORD,indate,intime,outtime,timediffer)VALUES(" + item.SubItems[8].Text + ",'" + item.SubItems[3].Text + "'," + item.SubItems[2].Text + "," + item.SubItems[4].Text + "," + 0 + "," + 0 + ",'" + item.SubItems[5].Text + "','" + Convert.ToDateTime(item.SubItems[6].Text).ToString("yyyy-MM-dd") + "','" + item.SubItems[7].Text + "','" + item.SubItems[12].Text + "','" + item.SubItems[11].Text + "')";
                                                Utility.ExecuteNonQuery(ins);
                                                string ins1 = "INSERT INTO " + Class.Users.HCompcode + "TRS_ATTLOG(MACHINENUMBER, IPADDRESS, ENROLLNO, VERIFYMODE, INOUTMODE, WORKCODE, DATETIMERECORD,indate,intime,outtime,timediffer,compcode)VALUES(" + item.SubItems[8].Text + ",'" + item.SubItems[3].Text + "'," + item.SubItems[2].Text + "," + item.SubItems[4].Text + "," + 0 + "," + 0 + ",'" + item.SubItems[5].Text + "','" + Convert.ToDateTime(item.SubItems[6].Text).ToString("yyyy-MM-dd") + "','" + item.SubItems[7].Text + "','" + item.SubItems[7].Text + "','" + item.SubItems[11].Text + "','" + Class.Users.HCompcode + "')";
                ...
                if (bIsConnected == true)
                {
                    ...
                    while (axCZKEM1.SSR_GetAllUserInfo(iMachineNumber, out sdwEnrollNumber, out sName, out sPassword, out iPrivilege, out bEnabled))//get all the users' information from the memory
                    {
                       ...
                       // {
                            ...
                            list2.SubItems.Add(sdwEnrollNumber.ToUpper());
                            list2.SubItems.Add(sName.ToUpper());
        ...
        private void Butreset_Click(object sender, EventArgs e)
        {
            ...
            //if (comboremoveip.SelectedValue != null)
            //{
            //    MyCount = 0;
            //    Cursor = Cursors.WaitCursor;
            //    bIsConnected = axCZKEM1.Connect_Net(comboremoveip.Text, Convert.ToInt32(txtPort.Text));
            ...
            //else
            //{
            //    MessageBox.Show("pls select Ip list in combobox");
            //}
        }
        ...
        private void ComboMasterIp_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboMasterIp.SelectedIndex > 0)
            {
                ...
                Lvdownall.Items.Clear(); allip.Items.Clear(); allip1.Items.Clear();
                listviewchecklistip1.Items.Clear(); listviewchecklistip2.Items.Clear();
            }
        ...
        {
            DeviceCommunication_Load(sender,e);
        }
        ...
        private void Export2Excel()
        {
            try
            {
                ...
                DirectoryInfo di = new DirectoryInfo(@"c:\Thulliam");
                if (di.Exists == false)
                    di.Create();
                StreamWriter sw = new StreamWriter(@"c:\Thulliam\'" + Class.Users.HCompcode + "'TodayAttLogs.xls", false);
                sw.AutoFlush = true;
                ...
                sw.Close();
                FileInfo fil = new FileInfo(@"c:\Thulliam\'" + Class.Users.HCompcode + "'TodayAttLogs.xls");
                if (fil.Exists == true)
                    MessageBox.Show("DownLoad Completed. \n Folder-Name is :c:\\Thulliam\\'" + Class.Users.HCompcode + "'TodayAttLogs.xls","Export to Excel", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
            }
        ...
        private void Btncarddownload_Click(object sender, EventArgs e)
        {
            ...
            SecondtabControl2.SelectTab(tab2card);
            listremovechecklistip.Items.Clear(); checkCard.Checked = false;
            ...
            if (bIsConnected == true)
            {
                ...
                while (axCZKEM1.SSR_GetAllUserInfo(iMachineNumber, out sdwEnrollNumber, out sName, out sPassword, out iPrivilege, out bEnabled))//get all the users' information from the memory
                {
                    ...
                    list.SubItems.Add(r.ToString());
                    list.SubItems.Add(sdwEnrollNumber.ToUpper());
                    //  list.Text = sdwEnrollNumber.ToString();
                    list.SubItems.Add(sName.ToUpper());
                    list.SubItems.Add(idwFingerIndex.ToString());
                    list.SubItems.Add(ssss);
