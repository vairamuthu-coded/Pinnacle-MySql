...
{
    public partial class NHDayEntryY : Form, ToolStripAccess
    {
        private static NHDayEntryY _instance;
        public static NHDayEntryY Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new NHDayEntryY();
                return _instance;
            }
        }
        public NHDayEntryY()
        ...
        {
            News_Click(sender, e); tabControl1.SelectTab(tabPagedel2);
        }
