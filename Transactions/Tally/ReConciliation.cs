            ...
            if (dataGridView1.Rows.Count > 1 && Class.Users.CompCode1 != "")
            {
                if (dataGridView2.Columns.Count >= 7)
                {
                    ...
                    if (frmtable != "")
                    {
                        ...
                        if (myTablename.Text == "MY COMPANY")
                        {
                            MessageBox.Show(Class.Users.CompCode1.ToString() + "  Data Imported Successfully", myTablename.Text);
                            tabControl1.SelectTab(tabPage4);
                        }
                        else
                        {
                            MessageBox.Show(Class.Users.CompCode1.ToString() + "  Customer/Supplier Data Imported Successfully", myTablename.Text);
                        ...
                        if (row["sts"].ToString() == "No")
                        {
                            ...
                            if (row.ItemArray[5].ToString() != "")
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        unmatched += hed1[3].ToString().Replace("x.", "") + ",";
                                    }
                                }
                            }
                            if (row.ItemArray[6].ToString() != "")
                            ...
                            if (row.ItemArray[7].ToString() != "" || row.ItemArray[7].ToString() == "")
                            {
                                Class.Users.Query = "";
                                DataTable dt2;
                                if (hed1.Length == 8)
                                ...
                                else
                                {
                                    ...
                                    {
                                         unmatched += hed1[8].ToString().Replace("x.", "") + ",";
                                    }
                                }
                            }
                            dt.Rows[k]["unmatched"] = unmatched;
                    ...
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        if (row["sts"].ToString() == "No")
                        {
                            ...
                            if (dt.Rows[k]["credit"].ToString() != "")
                            {
                                ...
                                if (hed1.Length == 8)
                                {
                                    dt2 = checkdata(hed1[5].ToString(), dt.Rows[k]["debit"].ToString(), tbl, hed1[4].ToString(), dt.Rows[k]["refno"].ToString());
                                    if (dt2.Rows.Count > 0)
                                    {
                                    }
                                    else
                   ...
                   foreach(DataRow row in dt2.Rows)
                    {
                        if (va == false)
                        {
                            cc = ""; cc = row[0].ToString().Replace("my_", "");
                            if (cc == Class.Users.CompCode1) { va = true; } else { va = false; }
                        }
                    }
                    if (va == true)
                    {
                    ...
                    {
                        MessageBox.Show("MyCompany:" + cc.ToString() + " ToCompany ; '" + Class.Users.CompCode1 + "'", "MisMatch Company Name" + cc.ToString());
                        Class.Users.CompCode1 = "";
